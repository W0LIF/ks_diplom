        ...
        <div class="login-form-container">
            <form id="loginForm" @submit="handleSubmit" novalidate autocomplete="off">
                ...
                <div class="form-group">
                    <input type="email" id="uEmail" name="uEmail" class="form-control" placeholder="Введите сюда почту"
                        v-model="loginObj.email" />
                </div>

                <div class="form-group">
                    <input type="password" id="uPass" name="uPass" class="form-control"
                        placeholder="Введите сюда пароль" v-model="loginObj.pass" autocomplete="on"/>
                </div>

                <div class="form-group">
                    <input type="submit" value="Войти" class="btn">
                    <p>Если нету аккаунта зарегистрируйтесь <router-link @click="scrollToTop()" to="/register">Регистрация
                        </router-link>
                    </p>
                </div>
            </form>
