<template>
    <div class="header">
        <router-link @click="scrollToTop()" to="/" class="logo"><img src="../assets/images/Untitled_logo_2_free-file.png" alt="" />
        </router-link>

        <nav class="navbar">
            <router-link @click="scrollToTop()" to="/">Главная</router-link>
            <router-link @click="scrollToTop()" to="/languages">Языки программирования</router-link>
            <router-link @click="scrollToTop()" to="/games">Создания игр</router-link>
        </nav>
        ...
        <div class="icons">
            ...
            <div v-else class="fas fa-user account" style="background: #f38609;color: white;" @click="showLog">
                <ul class="drop-down-select">
                    <li>
                        <router-link @click="scrollToTop()" to="/myorder">Личный кабинет</router-link>
                    </li>
                    <li>
